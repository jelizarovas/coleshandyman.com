      ...
      <section className=" py-10 bg-indigo-50">
        ...
        <div className="flex flex-wrap justify-around container mx-auto">
          {Object.keys(services).map((service) => (
            <div className="border-2 border-gray-600 m-2 my-10 bg-2 bg-white w-full md:w-96 rounded">
              ...
              <ul className="px-4 mx-2 py-2 text-xl ">
                {services[service].map((item) => (
                  <li className="px-4 py-2 text-xl hover:bg-gray-200 hover:font-bold transition-all cursor-pointer">
                    {item}
                  </li>
                ))}
              </ul>
